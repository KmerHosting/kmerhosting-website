...
const translations = {
  en: {
    ...
    "hosting.reseller.description": "Start your own hosting business with our white-label reseller plans. Manage multiple clients with ease.",
    ...
    "free.upload.requirements": "Requirements: Upload .zip file with project at first three directory levels, max 10MB, no backend",
    "free.upload.supported": "Supported: .zip only",
  ...
  fr: {
    ...
    "hosting.reseller.title": "Hébergement Revendeur",
    "hosting.reseller.description": "Lancez votre propre entreprise d'hébergement avec nos forfaits revendeurs en marque blanche. Gérez plusieurs clients facilement.",
    ...
    "free.upload.requirements": "Exigences : Téléchargez un fichier .zip avec le projet aux trois premiers niveaux de répertoire, max 10MB, pas de backend",
    "free.upload.supported": "Supporté : .zip uniquement",
