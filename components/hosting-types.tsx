    ...
    <section className="py-16 px-4 bg-slate-50 dark:bg-slate-800">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-2 text-slate-900 dark:text-white">Choose Your Hosting Type</h2>
          <p className="text-slate-600 dark:text-slate-400">Perfect hosting solutions tailored to your needs</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {hostingTypes.map((type, index) => (
            <div
              key={index}
              className="bg-white dark:bg-slate-900 rounded-xl p-6 border border-slate-200 dark:border-slate-700 hover:border-primary hover:shadow-lg transition-all duration-300"
            >
              <div className="mb-4">
                <span
              ...
              <h3 className="text-xl font-bold mb-2 text-slate-900 dark:text-white">{type.subtitle}</h3>
