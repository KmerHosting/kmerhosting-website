...
<body class="primary-bg-color kmerhosting-theme" data-phone-cc-input="{$phoneNumberInputStyle}">
    ...
    <header id="header" class="header kmer-header">
        ...
        <div class="navbar navbar-light" style="background: var(--kmer-bg); border-bottom: 1px solid var(--kmer-border); box-shadow: var(--kmer-shadow-sm);">
            <div class="container">
                <a class="navbar-brand mr-3" href="https://kmerhosting.com">
                    {if $assetLogoPath}
                        <img src="{$assetLogoPath}" alt="{$companyname}" class="logo-img" style="height: 32px; width: auto;">
                    {else}
