...
import { ArrowLeft, Copy, Eye, EyeOff, Check, Globe, AlertCircle } from "lucide-react"
...
export default function ResellerHostingPage() {
  ...
  const resellerServices: ResellerService[] = [
    {
      id: "1",
      name: "Reseller Plus",
      price: "36,000",
      ...
      bandwidth: "Unlimited",
      storage: "500 GB",
      panelUrl: "https://reseller.kmerhosting.com:2083",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">Reseller Hosting</h1>
            <button
        ...
        {!showServices && (
          <div className="text-center py-16">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">No Reseller Hosting Services</h2>
            <p className="text-slate-600 dark:text-slate-400 mb-8">You don't have any reseller hosting services yet</p>
              ...
              <div key={service.id} className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                    ...
                    <div>
                      ...
                      {service.suspendReason && (
                        <div className="flex items-center gap-2 mt-2 text-red-600 dark:text-red-400">
                          ...
                          <span className="text-sm">{service.suspendReason}</span>
                        </div>
                      )}
                    </div>
                ...
                <div className="p-6 border-b border-slate-200 dark:border-slate-700">
                  <div className="grid md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                      <p className="text-sm text-slate-600 dark:text-slate-400 mb-3 font-medium">Account Details</p>
                      <ul className="space-y-2 text-sm">
                        <li className="flex justify-between"><span className="text-slate-600 dark:text-slate-400">cPanel Accounts:</span> <span className="font-medium text-slate-900 dark:text-white">{service.cpanelAccounts}</span></li>
                        <li className="flex justify-between"><span className="text-slate-600 dark:text-slate-400">White Label:</span> <span className="font-medium text-slate-900 dark:text-white">{service.whiteLabel ? "Yes" : "No"}</span></li>
                      </ul>
                    </div>

                    <div>
                      <p className="text-sm text-slate-600 dark:text-slate-400 mb-3 font-medium">Resources</p>
                      <ul className="space-y-2 text-sm">
                ...
                <div className="p-6">
                  <h4 className="font-bold text-slate-900 dark:text-white mb-4">Reseller Panel Access</h4>

                  <div className="space-y-4">
                    {/* Panel URL */}
                    <div>
                      <label className="text-sm text-slate-600 dark:text-slate-400 mb-2 block">Control Panel URL</label>
