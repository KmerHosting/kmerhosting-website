...
import { ArrowLeft, Copy, Eye, EyeOff, Check, Server, AlertCircle } from "lucide-react"
  ...
  const vpsServices: VPSService[] = [
    {
      ...
      bandwidth: "Unlimited",
      os: "Ubuntu 22.04 LTS",
      panelUrl: "https://panel.vps.kmerhosting.com:2087",
      username: "root_vps",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <h1 className="text-3xl md:text-4xl font-bold text-slate-900 dark:text-white">VPS Hosting</h1>
            <button
        ...
        {!showServices && (
          <div className="text-center py-16">
            <div className="mb-4 flex justify-center">
              <Server className="w-16 h-16 text-slate-300 dark:text-slate-600" />
            </div>
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2">No VPS Hosting Services</h2>
            <p className="text-slate-600 dark:text-slate-400 mb-8">You don't have any VPS hosting services yet</p>
              ...
              <div key={service.id} className="bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
                ...
                <div className="p-6 border-b border-slate-200 dark:border-slate-700">
                  <div className="grid md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                      <p className="text-sm text-slate-600 dark:text-slate-400 mb-3 font-medium">Specifications</p>
                    ...
                    <div>
                      <p className="text-sm text-slate-600 dark:text-slate-400 mb-3 font-medium">Additional Info</p>
                      <ul className="space-y-2 text-sm">
                ...
                <div className="p-6">
                  <h4 className="font-bold text-slate-900 dark:text-white mb-4">Server Access</h4>
