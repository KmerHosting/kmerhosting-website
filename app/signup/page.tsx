...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Account created! Check your email for verification link.", { duration: 5000 })
      setIsSuccess(true)
      setEmail("")
    } catch (err) {
        ...
        {isSuccess ? (
          <div className="text-center">
            ...
            <p className="text-slate-600 dark:text-slate-400 mb-4 text-sm">
              If the email address you entered does not match an existing account, you will receive a verification link shortly.
            </p>
          ...
          <div>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-sm mb-6">
              Start hosting with KmerHosting today
            </p>
